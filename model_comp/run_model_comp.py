...
h_lambda_von_infile_phsd = rt.TFile("sanitize/tmp_phsd_outfile.root", "READ")
h_lambda_von_phsd = h_lambda_von_infile_phsd.Get("h_lambda_von_fit")
h_lambda_von_phsd.SetParameter(0, 0)
h_lambda_von_phsd.SetLineColor(rt.kRed + 2)
h_lambda_von_phsd.SetLineWidth(2)
h_lambda_von_phsd.SetLineStyle(2)

h_lambda_von_infile_dpmjet = rt.TFile("sanitize/tmp_dpmjet_outfile.root", "READ")
h_lambda_von_dpmjet = h_lambda_von_infile_dpmjet.Get("h_lambda_von_fit")
h_lambda_von_dpmjet.SetParameter(0, 0)  
h_lambda_von_dpmjet.SetLineColor(rt.kBlue + 2)
h_lambda_von_dpmjet.SetLineWidth(2)
h_lambda_von_dpmjet.SetLineStyle(2)
...
von_fit_data.SetParameter(3, 20)
von_fit_data.SetParLimits(3, 0, 100)
h_lambda_1d_data_subtracted_with_fit = h_lambda_1d_data_subtracted.Clone("h_lambda_1d_data_subtracted_with_fit")
h_lambda_1d_data_subtracted_with_fit.Fit(von_fit_data, "R")

legend_1d_subtracted = rt.TLegend(0.65, 0.75, 0.9, 0.87)
legend_1d_subtracted.AddEntry(h_lambda_1d_data, "Data (UE subtracted)")
legend_1d_subtracted.AddEntry(h_lambda_von_dpmjet, "DPMJet", "l")
# legend_1d_subtracted.AddEntry(h_lambda_1d_epos, "EPOS-LHC (UE subtracted)")
legend_1d_subtracted.AddEntry(h_lambda_von_phsd, "PHSD", "l")
legend_1d_subtracted.SetBorderSize(0)
legend_1d_subtracted.SetFillStyle(0)
h_lambda_1d_data_subtracted_with_fit.GetYaxis().SetRangeUser(-0.001, 0.016)
h_lambda_1d_data_subtracted_with_fit.Draw()
h_lambda_von_dpmjet.Draw("SAME")
h_lambda_von_phsd.Draw("SAME")
