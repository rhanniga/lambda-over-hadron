AliAnalysisTaskLambdaHadronCloseTrackEff* AddLambdaHadronCloseTrackEffTask(
  TString name = "lambdaHadronCloseTrackEff",
  float multLow = 0, 
  float multHigh = 80,
  ...
  AliAnalysisTaskLambdaHadronCloseTrackEff* task = new AliAnalysisTaskLambdaHadronCloseTrackEff(name.Data());
