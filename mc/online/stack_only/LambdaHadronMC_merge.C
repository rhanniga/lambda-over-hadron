void LambdaHadronMC_merge(const char *dir, Int_t stage=0)
{
...
// Analysis source to be compiled at runtime (if any)
   gROOT->ProcessLine(".L AliAnalysisTaskLambdaHadronMC.cxx+g");
...
// Set temporary compilation directory to current one
   ...
   TString outputFile;
   Bool_t merged = kTRUE;
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("LambdaHadronMC.root");
   if (!mgr) {
