...
def make_dumb_plot(near_ratios, away_ratios, ue_ratios, name):


    colors = [rt.kRed - 2, rt.kBlue - 2, rt.kGreen - 2, rt.kMagenta - 2]

    central_h = rt.TH1F("central_h", "", 3, 0, 3)
    central_h.SetBinContent(1, 0)
    central_h.SetBinContent(2, 0)
    central_h.SetBinContent(3, 0)
    central_h.SetLineColor(rt.kBlack)
    central_h.SetLineWidth(2)
    central_h.SetMarkerStyle(34)
    central_h.SetMarkerSize(2)
    central_h.GetXaxis().SetTitle("Kinematic Region")
    central_h.GetYaxis().SetTitle("Deviation from default")
    central_h.GetYaxis().SetRangeUser(-0.25, 0.25)
    central_h.GetXaxis().SetBinLabel(1, "Near-side")
    central_h.GetXaxis().SetBinLabel(2, "Away-side")
    central_h.GetXaxis().SetBinLabel(3, "UE")
    ...
    leg.AddEntry(central_h, "default", "lep")

    central_h.Draw()
    lut_index = 0
    pointer_list = []
    for nval, aval, ueval in zip(near_ratios, away_ratios, ue_ratios):
        var_hist = rt.TH1F("var_hist", "", 3, 0, 3)
        var_hist.SetName(lut[lut_index])
        var_hist.SetBinContent(1, nval)
        var_hist.SetBinContent(2, aval)
        var_hist.SetBinContent(3, ueval)
        var_hist.SetLineColor(colors[lut_index])
        var_hist.SetLineWidth(2)
        var_hist.SetMarkerStyle(34)
        var_hist.SetMarkerSize(2)
        var_hist.SetMarkerColor(colors[lut_index])
        clone = var_hist.Clone()
        pointer_list.append(clone)
        clone.Draw("same")
        leg.AddEntry(clone, lut[lut_index], "lep")
        leg.Draw()
        sleep(0.1)
    ...
    c.Draw()
    c.SaveAs(f"figures/{name}_yield_variation.pdf")
...
total_nch_dep_dphi_sys_0_20 = 0.0064
total_nch_dep_dphi_sys_20_50 = 0.0096
total_nch_dep_dphi_sys_50_80 = 0.021

hh_total_dphi_sys_0_20 = 0.035
hh_total_dphi_sys_20_50 = 0.035
hh_total_dphi_sys_50_80 = 0.035

hh_total_nch_dep_dphi_sys_0_20 = 0.0
hh_total_nch_dep_dphi_sys_20_50 = 0.0
hh_total_nch_dep_dphi_sys_50_80 = 0.0


for PT_MODE in [0, 1, 2]:

    if PT_MODE == 1:
        avg6_file = rt.TFile("output/central_value/v0_avg6_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_15_25_delta_eta_12_normal_lowpt.root")
        avg4_file = rt.TFile("output/yield_variation/v0_avg4_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_15_25_delta_eta_12_normal_lowpt.root")
        avg6nonneg_file = rt.TFile("output/yield_variation/v0_avg6nonneg_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_15_25_delta_eta_12_normal_lowpt.root")
        v2_file = rt.TFile("output/yield_variation/v0_v2_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_15_25_delta_eta_12_normal_lowpt.root")
        # zyam_file = rt.TFile("output/yield_variation/v0_zyam_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_15_25_delta_eta_12_normal_lowpt.root")
        file_dict = {
            "6 bin avg": avg6_file,
            "4 bin avg": avg4_file,
        ...
        avg6_file = rt.TFile("output/central_value/v0_avg6_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_25_40_delta_eta_12_normal_highpt.root")
        avg4_file = rt.TFile("output/yield_variation/v0_avg4_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_25_40_delta_eta_12_normal_highpt.root")
        avg6nonneg_file = rt.TFile("output/yield_variation/v0_avg6nonneg_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_25_40_delta_eta_12_normal_highpt.root")
        v2_file = rt.TFile("output/yield_variation/v0_v2_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_25_40_delta_eta_12_normal_highpt.root")
        # zyam_file = rt.TFile("output/yield_variation/v0_zyam_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_25_40_delta_eta_12_normal_highpt.root")
        file_dict = {
            "6 bin avg": avg6_file,
            "4 bin avg": avg4_file,
            "6 bin avg nonneg": avg6nonneg_file,
        ...
        avg6_file = rt.TFile("output/central_value/v0_avg6_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_20_40_delta_eta_12_normal.root")
        avg4_file = rt.TFile("output/yield_variation/v0_avg4_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_20_40_delta_eta_12_normal.root")
        avg6nonneg_file = rt.TFile("output/yield_variation/v0_avg6nonneg_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_20_40_delta_eta_12_normal.root")
        v2_file = rt.TFile("output/yield_variation/v0_v2_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_20_40_delta_eta_12_normal.root")
        # zyam_file = rt.TFile("output/yield_variation/v0_zyam_sideband_subtraction_rsb_1135_115_sig_1102_113_trig_40_80_assoc_20_40_delta_eta_12_normal.root")
        file_dict = {
            "6 bin avg": avg6_file,
            "4 bin avg": avg4_file,
            "6 bin avg nonneg": avg6nonneg_file,
    ...
    h_lambda_near_dict_minbias = {}
    h_lambda_away_dict_minbias = {}
    h_lambda_ue_dict_minbias = {}
    h_lambda_total_dict_minbias = {}
    h_h_near_dict_minbias = {}
    h_h_away_dict_minbias = {}
    h_h_ue_dict_minbias = {}
    h_h_total_dict_minbias = {}
    ...
    for key in file_dict:
        ...
        h_lambda_near_dict_minbias[key] = file_dict[key].Get("h_lambda_near_graph_minbias")
        h_lambda_away_dict_minbias[key] = file_dict[key].Get("h_lambda_away_graph_minbias")
        h_lambda_ue_dict_minbias[key] = file_dict[key].Get("h_lambda_ue_graph_minbias")
        h_lambda_total_dict_minbias[key] = file_dict[key].Get("h_lambda_total_graph_minbias")
        h_h_near_dict_minbias[key] = file_dict[key].Get("h_h_near_graph_minbias")
        h_h_away_dict_minbias[key] = file_dict[key].Get("h_h_away_graph_minbias")
        h_h_ue_dict_minbias[key] = file_dict[key].Get("h_h_ue_graph_minbias")
        h_h_total_dict_minbias[key] = file_dict[key].Get("h_h_total_graph_minbias")
    ...
    for key in file_dict:
        ...
        hl_near_graph_minbias = h_lambda_near_dict_minbias[key]
        hl_away_graph_minbias = h_lambda_away_dict_minbias[key]
        hl_ue_graph_minbias = h_lambda_ue_dict_minbias[key]
        hl_total_graph_minbias = h_lambda_total_dict_minbias[key]
        hh_near_graph_minbias = h_h_near_dict_minbias[key]
        hh_away_graph_minbias = h_h_away_dict_minbias[key]
        hh_ue_graph_minbias = h_h_ue_dict_minbias[key]
        hh_total_graph_minbias = h_h_total_dict_minbias[key]
    ...
    central_value = 0
    central_value_minbias = 0
    r_squared = 0
    for key in h_lambda_near_dict:
        if key == CENTRAL_TECHNIQUE:
            central_value = h_lambda_near_dict[key].GetY()[2]
            central_value_minbias = h_lambda_near_dict_minbias[key].GetY()[0]
        else:
            h_lambda_near_ratios_0_20.append((h_lambda_near_dict[key].GetY()[2]/central_value) - 1)
            r_squared += (((h_lambda_near_dict[key].GetY()[2]/central_value)/(h_lambda_near_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    rms_0_20 = get_rms(h_lambda_near_ratios_0_20)
    r_0_20 = math.sqrt(r_squared)
    ...
    for key in h_lambda_near_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_lambda_near_dict[key].GetY()[1]/central_value)/(h_lambda_near_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    rms_20_50 = get_rms(h_lambda_near_ratios_20_50)
    r_20_50 = math.sqrt(r_squared)
    ...
    for key in h_lambda_near_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_lambda_near_dict[key].GetY()[0]/central_value)/(h_lambda_near_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    rms_50_80 = get_rms(h_lambda_near_ratios_50_80)
    r_50_80 = math.sqrt(r_squared)
    ...
    # near yield extraction is anti-correlated with mult, use normal RMS instead of R
    near_yield_0_20_nch_dep_systematic = math.sqrt(rms_0_20**2 + total_nch_dep_dphi_sys_0_20**2)
    near_yield_20_50_nch_dep_systematic = math.sqrt(rms_20_50**2 + total_nch_dep_dphi_sys_20_50**2)
    near_yield_50_80_nch_dep_systematic = math.sqrt(rms_50_80**2 + total_nch_dep_dphi_sys_50_80**2)
    ...
    for key in h_lambda_away_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            central_value_minbias = h_lambda_away_dict_minbias[key].GetY()[0]
        else:
            h_lambda_away_ratios_0_20.append((h_lambda_away_dict[key].GetY()[2]/central_value) - 1)
            r_squared += (((h_lambda_away_dict[key].GetY()[2]/central_value)/(h_lambda_away_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_lambda_away_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_lambda_away_dict[key].GetY()[1]/central_value)/(h_lambda_away_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_lambda_away_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_lambda_away_dict[key].GetY()[0]/central_value)/(h_lambda_away_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    # away yield extraction is anti-correlated with mult, use normal RMS instead of R
    away_yield_0_20_nch_dep_systematic = math.sqrt(rms_0_20**2 + total_nch_dep_dphi_sys_0_20**2)
    away_yield_20_50_nch_dep_systematic = math.sqrt(rms_20_50**2 + total_nch_dep_dphi_sys_20_50**2)
    away_yield_50_80_nch_dep_systematic = math.sqrt(rms_50_80**2 + total_nch_dep_dphi_sys_50_80**2)
    ...
    for key in h_lambda_total_dict:
        if key == CENTRAL_TECHNIQUE:
            central_value = h_lambda_total_dict[key].GetY()[2]
            central_value_minbias = h_lambda_total_dict_minbias[key].GetY()[0]
        else:
            h_lambda_total_ratios_0_20.append((h_lambda_total_dict[key].GetY()[2]/central_value) - 1)
            r_squared += (((h_lambda_total_dict[key].GetY()[2]/central_value)/(h_lambda_total_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_lambda_total_dict:
        if key == CENTRAL_TECHNIQUE:
            central_value = h_lambda_total_dict[key].GetY()[1]
            central_value_minbias = h_lambda_total_dict_minbias[key].GetY()[0]
        else:
            h_lambda_total_ratios_20_50.append((h_lambda_total_dict[key].GetY()[1]/central_value) - 1)
            r_squared += (((h_lambda_total_dict[key].GetY()[1]/central_value)/(h_lambda_total_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_lambda_total_dict:
        if key == CENTRAL_TECHNIQUE:
            central_value = h_lambda_total_dict[key].GetY()[0]
            central_value_minbias = h_lambda_total_dict_minbias[key].GetY()[0]
        else:
            h_lambda_total_ratios_50_80.append((h_lambda_total_dict[key].GetY()[0]/central_value) - 1)
            r_squared += (((h_lambda_total_dict[key].GetY()[0]/central_value)/(h_lambda_total_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    total_yield_0_20_nch_dep_systematic = math.sqrt(r_0_20**2 + total_nch_dep_dphi_sys_0_20**2)
    total_yield_20_50_nch_dep_systematic = math.sqrt(r_20_50**2 + total_nch_dep_dphi_sys_20_50**2)
    total_yield_50_80_nch_dep_systematic = math.sqrt(r_50_80**2 + total_nch_dep_dphi_sys_50_80**2)
    ...
    for key in h_lambda_ue_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            central_value_minbias = h_lambda_ue_dict_minbias[key].GetY()[0]
        else:
            h_lambda_ue_ratios_0_20.append((h_lambda_ue_dict[key].GetY()[2]/central_value) - 1)
            r_squared += (((h_lambda_ue_dict[key].GetY()[2]/central_value)/(h_lambda_ue_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_lambda_ue_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_lambda_ue_dict[key].GetY()[1]/central_value)/(h_lambda_ue_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_lambda_ue_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_lambda_ue_dict[key].GetY()[0]/central_value)/(h_lambda_ue_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    ue_yield_0_20_nch_dep_systematic = math.sqrt(r_0_20**2 + total_nch_dep_dphi_sys_0_20**2)
    ue_yield_20_50_nch_dep_systematic = math.sqrt(r_20_50**2 + total_nch_dep_dphi_sys_20_50**2)
    ue_yield_50_80_nch_dep_systematic = math.sqrt(r_50_80**2 + total_nch_dep_dphi_sys_50_80**2)
    ...
    for key in h_h_near_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            central_value_minbias = h_h_near_dict_minbias[key].GetY()[0]
        else:
            h_h_near_ratios_0_20.append((h_h_near_dict[key].GetY()[2]/central_value) - 1)
            r_squared += (((h_h_near_dict[key].GetY()[2]/central_value)/(h_h_near_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_h_near_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_h_near_dict[key].GetY()[1]/central_value)/(h_h_near_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_h_near_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_h_near_dict[key].GetY()[0]/central_value)/(h_h_near_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    # near yield extraction is anti-correlated with multiplicity, use RMS instead of R
    hh_near_yield_0_20_nch_dep_systematic = math.sqrt(rms_0_20**2 + hh_total_nch_dep_dphi_sys_0_20**2)
    hh_near_yield_20_50_nch_dep_systematic = math.sqrt(rms_20_50**2 + hh_total_nch_dep_dphi_sys_20_50**2)
    hh_near_yield_50_80_nch_dep_systematic = math.sqrt(rms_50_80**2 + hh_total_nch_dep_dphi_sys_50_80**2)
    ...
    for key in h_h_away_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            central_value_minbias = h_h_away_dict_minbias[key].GetY()[0]
        else:
            h_h_away_ratios_0_20.append((h_h_away_dict[key].GetY()[2]/central_value) - 1)
            r_squared += (((h_h_away_dict[key].GetY()[2]/central_value)/(h_h_away_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_h_away_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_h_away_dict[key].GetY()[1]/central_value)/(h_h_away_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_h_away_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_h_away_dict[key].GetY()[0]/central_value)/(h_h_away_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    # away yield extraction is anti-correlated with multiplicity, use RMS instead of R
    hh_away_yield_0_20_nch_dep_systematic = math.sqrt(rms_0_20**2 + hh_total_nch_dep_dphi_sys_0_20**2)
    hh_away_yield_20_50_nch_dep_systematic = math.sqrt(rms_20_50**2 + hh_total_nch_dep_dphi_sys_20_50**2)
    hh_away_yield_50_80_nch_dep_systematic = math.sqrt(rms_50_80**2 + hh_total_nch_dep_dphi_sys_50_80**2)
    ...
    for key in h_h_total_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            central_value_minbias = h_h_total_dict_minbias[key].GetY()[0]
        else:
            h_h_total_ratios_0_20.append((h_h_total_dict[key].GetY()[2]/central_value) - 1)
            r_squared += (((h_h_total_dict[key].GetY()[2]/central_value)/(h_h_total_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_h_total_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_h_total_dict[key].GetY()[1]/central_value)/(h_h_total_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_h_total_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_h_total_dict[key].GetY()[0]/central_value)/(h_h_total_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    hh_total_yield_0_20_nch_dep_systematic = math.sqrt(r_0_20**2 + hh_total_nch_dep_dphi_sys_0_20**2)
    hh_total_yield_20_50_nch_dep_systematic = math.sqrt(r_20_50**2 + hh_total_nch_dep_dphi_sys_20_50**2)
    hh_total_yield_50_80_nch_dep_systematic = math.sqrt(r_50_80**2 + hh_total_nch_dep_dphi_sys_50_80**2)
    ...
    for key in h_h_ue_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            central_value_minbias = h_h_ue_dict_minbias[key].GetY()[0]
        else:
            h_h_ue_ratios_0_20.append((h_h_ue_dict[key].GetY()[2]/central_value) - 1)
            r_squared += (((h_h_ue_dict[key].GetY()[2]/central_value)/(h_h_ue_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_h_ue_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_h_ue_dict[key].GetY()[1]/central_value)/(h_h_ue_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    for key in h_h_ue_dict:
        if key == CENTRAL_TECHNIQUE:
            ...
            r_squared += (((h_h_ue_dict[key].GetY()[0]/central_value)/(h_h_ue_dict_minbias[key].GetY()[0]/central_value_minbias)) - 1)**2
    ...
    hh_ue_yield_0_20_nch_dep_systematic = math.sqrt(r_0_20**2 + hh_total_nch_dep_dphi_sys_0_20**2)
    hh_ue_yield_20_50_nch_dep_systematic = math.sqrt(r_20_50**2 + hh_total_nch_dep_dphi_sys_20_50**2)
    hh_ue_yield_50_80_nch_dep_systematic = math.sqrt(r_50_80**2 + hh_total_nch_dep_dphi_sys_50_80**2)


    if PT_MODE == 0:

        make_dumb_plot(h_lambda_near_ratios_0_20, h_lambda_away_ratios_0_20, h_lambda_ue_ratios_0_20, "h_lambda_0_20")
        make_dumb_plot(h_h_near_ratios_0_20, h_h_away_ratios_0_20, h_h_ue_ratios_0_20, "h_h_0_20")
        make_dumb_plot(h_lambda_near_ratios_20_50, h_lambda_away_ratios_20_50, h_lambda_ue_ratios_20_50, "h_lambda_20_50")
        make_dumb_plot(h_h_near_ratios_20_50, h_h_away_ratios_20_50, h_h_ue_ratios_20_50, "h_h_20_50")
        make_dumb_plot(h_lambda_near_ratios_50_80, h_lambda_away_ratios_50_80, h_lambda_ue_ratios_50_80, "h_lambda_50_80")
        make_dumb_plot(h_h_near_ratios_50_80, h_h_away_ratios_50_80, h_h_ue_ratios_50_80, "h_h_50_80")
    elif PT_MODE == 1:
        make_dumb_plot(h_lambda_near_ratios_0_20, h_lambda_away_ratios_0_20, h_lambda_ue_ratios_0_20, "h_lambda_0_20_lowpt")
        make_dumb_plot(h_h_near_ratios_0_20, h_h_away_ratios_0_20, h_h_ue_ratios_0_20, "h_h_0_20_lowpt")
        make_dumb_plot(h_lambda_near_ratios_20_50, h_lambda_away_ratios_20_50, h_lambda_ue_ratios_20_50, "h_lambda_20_50_lowpt")
        make_dumb_plot(h_h_near_ratios_20_50, h_h_away_ratios_20_50, h_h_ue_ratios_20_50, "h_h_20_50_lowpt")
        make_dumb_plot(h_lambda_near_ratios_50_80, h_lambda_away_ratios_50_80, h_lambda_ue_ratios_50_80, "h_lambda_50_80_lowpt")
        make_dumb_plot(h_h_near_ratios_50_80, h_h_away_ratios_50_80, h_h_ue_ratios_50_80, "h_h_50_80_lowpt")
    elif PT_MODE == 2:
        make_dumb_plot(h_lambda_near_ratios_0_20, h_lambda_away_ratios_0_20, h_lambda_ue_ratios_0_20, "h_lambda_0_20_highpt")
        make_dumb_plot(h_h_near_ratios_0_20, h_h_away_ratios_0_20, h_h_ue_ratios_0_20, "h_h_0_20_highpt")
        make_dumb_plot(h_lambda_near_ratios_20_50, h_lambda_away_ratios_20_50, h_lambda_ue_ratios_20_50, "h_lambda_20_50_highpt")
        make_dumb_plot(h_h_near_ratios_20_50, h_h_away_ratios_20_50, h_h_ue_ratios_20_50, "h_h_20_50_highpt")
        make_dumb_plot(h_lambda_near_ratios_50_80, h_lambda_away_ratios_50_80, h_lambda_ue_ratios_50_80, "h_lambda_50_80_highpt")
        make_dumb_plot(h_h_near_ratios_50_80, h_h_away_ratios_50_80, h_h_ue_ratios_50_80, "h_h_50_80_highpt")

    if PRINT_SYSTEMATICS:

        print("---------------h lambda yield systematics----------------")
        print(f"0-20\% & {near_yield_0_20_systematic*100:.2e} & {away_yield_0_20_systematic*100:.2e}  & {ue_yield_0_20_systematic*100:.2e} & {total_yield_0_20_systematic*100:.2e} \\\\")
        print(f"20-50\% & {near_yield_20_50_systematic*100:.2e} & {away_yield_20_50_systematic*100:.2e}  & {ue_yield_20_50_systematic*100:.2e} & {total_yield_20_50_systematic*100:.2e} \\\\")
        print(f"50-80\% & {near_yield_50_80_systematic*100:.2e} & {away_yield_50_80_systematic*100:.2e}  & {ue_yield_50_80_systematic*100:.2e} & {total_yield_50_80_systematic*100:.2e} \\\\")

        print("---------------h h yield systematic*100s----------------")
        print(f"0-20\% & {hh_near_yield_0_20_systematic*100:.2e}   & {hh_away_yield_0_20_systematic*100:.2e}  & {hh_ue_yield_0_20_systematic*100:.2e} & {hh_total_yield_0_20_systematic*100:.2e} \\\\")
        print(f"20-50\% & {hh_near_yield_20_50_systematic*100:.2e} & {hh_away_yield_20_50_systematic*100:.2e}  & {hh_ue_yield_20_50_systematic*100:.2e} & {hh_total_yield_20_50_systematic*100:.2e} \\\\")
        print(f"50-80\% & {hh_near_yield_50_80_systematic*100:.2e} & {hh_away_yield_50_80_systematic*100:.2e}  & {hh_ue_yield_50_80_systematic*100:.2e} & {hh_total_yield_50_80_systematic*100:.2e} \\\\")

        print("---------------h lambda yield nch_dep_systematics----------------")
        print(f"0-20\% & {near_yield_0_20_nch_dep_systematic*100:.2e} & {away_yield_0_20_nch_dep_systematic*100:.2e}  & {ue_yield_0_20_nch_dep_systematic*100:.2e} & {total_yield_0_20_nch_dep_systematic*100:.2e} \\\\")
        print(f"20-50\% & {near_yield_20_50_nch_dep_systematic*100:.2e} & {away_yield_20_50_nch_dep_systematic*100:.2e}  & {ue_yield_20_50_nch_dep_systematic*100:.2e} & {total_yield_20_50_nch_dep_systematic*100:.2e} \\\\")
        print(f"50-80\% & {near_yield_50_80_nch_dep_systematic*100:.2e} & {away_yield_50_80_nch_dep_systematic*100:.2e}  & {ue_yield_50_80_nch_dep_systematic*100:.2e} & {total_yield_50_80_nch_dep_systematic*100:.2e} \\\\")

        print("---------------h h yield nch_dep_systematic*100s----------------")
        print(f"0-20\% & {hh_near_yield_0_20_nch_dep_systematic*100:.2e}   & {hh_away_yield_0_20_nch_dep_systematic*100:.2e}  & {hh_ue_yield_0_20_nch_dep_systematic*100:.2e} & {hh_total_yield_0_20_nch_dep_systematic*100:.2e} \\\\")
        print(f"20-50\% & {hh_near_yield_20_50_nch_dep_systematic*100:.2e} & {hh_away_yield_20_50_nch_dep_systematic*100:.2e}  & {hh_ue_yield_20_50_nch_dep_systematic*100:.2e} & {hh_total_yield_20_50_nch_dep_systematic*100:.2e} \\\\")
        print(f"50-80\% & {hh_near_yield_50_80_nch_dep_systematic*100:.2e} & {hh_away_yield_50_80_nch_dep_systematic*100:.2e}  & {hh_ue_yield_50_80_nch_dep_systematic*100:.2e} & {hh_total_yield_50_80_nch_dep_systematic*100:.2e} \\\\")
    ...
    near_yield_systematics = arr.array('d', [near_yield_50_80_systematic*near_graph.GetY()[0], near_yield_20_50_systematic*near_graph.GetY()[1], near_yield_0_20_systematic*near_graph.GetY()[2]])
    ...
    near_yield_nch_dep_systematics = arr.array('d', [near_yield_50_80_nch_dep_systematic*near_graph.GetY()[0], near_yield_20_50_nch_dep_systematic*near_graph.GetY()[1], near_yield_0_20_nch_dep_systematic*near_graph.GetY()[2]])
    away_yield_nch_dep_systematics = arr.array('d', [away_yield_50_80_nch_dep_systematic*away_graph.GetY()[0], away_yield_20_50_nch_dep_systematic*away_graph.GetY()[1], away_yield_0_20_nch_dep_systematic*away_graph.GetY()[2]])
    ue_yield_nch_dep_systematics = arr.array('d', [ue_yield_50_80_nch_dep_systematic*ue_graph.GetY()[0], ue_yield_20_50_nch_dep_systematic*ue_graph.GetY()[1], ue_yield_0_20_nch_dep_systematic*ue_graph.GetY()[2]])
    total_yield_nch_dep_systematics = arr.array('d', [total_yield_50_80_nch_dep_systematic*total_graph.GetY()[0], total_yield_20_50_nch_dep_systematic*total_graph.GetY()[1], total_yield_0_20_nch_dep_systematic*total_graph.GetY()[2]])
    ...
    hh_near_yield_nch_dep_systematics = arr.array('d', [hh_near_yield_50_80_nch_dep_systematic*hh_near_graph.GetY()[0], hh_near_yield_20_50_nch_dep_systematic*hh_near_graph.GetY()[1], hh_near_yield_0_20_nch_dep_systematic*hh_near_graph.GetY()[2]])
    hh_away_yield_nch_dep_systematics = arr.array('d', [hh_away_yield_50_80_nch_dep_systematic*hh_away_graph.GetY()[0], hh_away_yield_20_50_nch_dep_systematic*hh_away_graph.GetY()[1], hh_away_yield_0_20_nch_dep_systematic*hh_away_graph.GetY()[2]])
    hh_ue_yield_nch_dep_systematics = arr.array('d', [hh_ue_yield_50_80_nch_dep_systematic*hh_ue_graph.GetY()[0], hh_ue_yield_20_50_nch_dep_systematic*hh_ue_graph.GetY()[1], hh_ue_yield_0_20_nch_dep_systematic*hh_ue_graph.GetY()[2]])
    hh_total_yield_nch_dep_systematics = arr.array('d', [hh_total_yield_50_80_nch_dep_systematic*hh_total_graph.GetY()[0], hh_total_yield_20_50_nch_dep_systematic*hh_total_graph.GetY()[1], hh_total_yield_0_20_nch_dep_systematic*hh_total_graph.GetY()[2]])

    near_graph_final_syst = rt.TGraphAsymmErrors( 3, mult_list, near_yield_values, mult_error_list_sys, mult_error_list_sys, near_yield_systematics, near_yield_systematics)
    ...
    near_graph_final_nch_dep_syst = rt.TGraphAsymmErrors( 3, mult_list, near_yield_values, mult_error_list_sys, mult_error_list_sys, near_yield_nch_dep_systematics, near_yield_nch_dep_systematics)
    away_graph_final_nch_dep_syst = rt.TGraphAsymmErrors( 3, mult_list, away_yield_values, mult_error_list_sys, mult_error_list_sys, away_yield_nch_dep_systematics, away_yield_nch_dep_systematics)
    ue_graph_final_nch_dep_syst = rt.TGraphAsymmErrors( 3, mult_list, ue_yield_values, mult_error_list_sys, mult_error_list_sys, ue_yield_nch_dep_systematics, ue_yield_nch_dep_systematics)
    total_graph_final_nch_dep_syst = rt.TGraphAsymmErrors( 3, mult_list, total_yield_values, mult_error_list_sys, mult_error_list_sys, total_yield_nch_dep_systematics, total_yield_nch_dep_systematics)
    hh_near_graph_final_nch_dep_syst = rt.TGraphAsymmErrors( 3, mult_list, hh_near_yield_values, mult_error_list_sys, mult_error_list_sys, hh_near_yield_nch_dep_systematics, hh_near_yield_nch_dep_systematics)
    hh_away_graph_final_nch_dep_syst = rt.TGraphAsymmErrors( 3, mult_list, hh_away_yield_values, mult_error_list_sys, mult_error_list_sys, hh_away_yield_nch_dep_systematics, hh_away_yield_nch_dep_systematics)
    hh_ue_graph_final_nch_dep_syst = rt.TGraphAsymmErrors( 3, mult_list, hh_ue_yield_values, mult_error_list_sys, mult_error_list_sys, hh_ue_yield_nch_dep_systematics, hh_ue_yield_nch_dep_systematics)
    hh_total_graph_final_nch_dep_syst = rt.TGraphAsymmErrors( 3, mult_list, hh_total_yield_values, mult_error_list_sys, mult_error_list_sys, hh_total_yield_nch_dep_systematics, hh_total_yield_nch_dep_systematics)
    ...
    near_ratio_graph_values = arr.array('d', [near_ratio_graph.GetY()[i] for i in range(3)])
    near_ratio_graph_nch_dep_sys = arr.array('d', [ratio_error(near_graph_final_nch_dep_syst.GetY()[i], hh_near_graph_final_nch_dep_syst.GetY()[i], near_graph_final_nch_dep_syst.GetEYhigh()[i], hh_near_graph_final_nch_dep_syst.GetEYhigh()[i]) for i in range(3)])
    away_ratio_graph_values = arr.array('d', [away_ratio_graph.GetY()[i] for i in range(3)])
    away_ratio_graph_nch_dep_sys = arr.array('d', [ratio_error(away_graph_final_nch_dep_syst.GetY()[i], hh_away_graph_final_nch_dep_syst.GetY()[i], away_graph_final_nch_dep_syst.GetEYhigh()[i], hh_away_graph_final_nch_dep_syst.GetEYhigh()[i]) for i in range(3)])
    ue_ratio_graph_values = arr.array('d', [ue_ratio_graph.GetY()[i] for i in range(3)])
    ue_ratio_graph_nch_dep_sys = arr.array('d', [ratio_error(ue_graph_final_nch_dep_syst.GetY()[i], hh_ue_graph_final_nch_dep_syst.GetY()[i], ue_graph_final_nch_dep_syst.GetEYhigh()[i], hh_ue_graph_final_nch_dep_syst.GetEYhigh()[i]) for i in range(3)])
    total_ratio_graph_values = arr.array('d', [total_ratio_graph.GetY()[i] for i in range(3)])
    total_ratio_graph_nch_dep_sys = arr.array('d', [ratio_error(total_graph_final_nch_dep_syst.GetY()[i], hh_total_graph_final_nch_dep_syst.GetY()[i], total_graph_final_nch_dep_syst.GetEYhigh()[i], hh_total_graph_final_nch_dep_syst.GetEYhigh()[i]) for i in range(3)])
    near_ratio_graph_final_nch_dep_syst = rt.TGraphErrors(3, mult_list, near_ratio_graph_values, mult_error_list_sys, near_ratio_graph_nch_dep_sys)
    away_ratio_graph_final_nch_dep_syst = rt.TGraphErrors(3, mult_list, away_ratio_graph_values, mult_error_list_sys, away_ratio_graph_nch_dep_sys)
    ue_ratio_graph_final_nch_dep_syst = rt.TGraphErrors(3, mult_list, ue_ratio_graph_values, mult_error_list_sys, ue_ratio_graph_nch_dep_sys)
    total_ratio_graph_final_nch_dep_syst = rt.TGraphErrors(3, mult_list, total_ratio_graph_values, mult_error_list_sys, total_ratio_graph_nch_dep_sys)
    ...
    near_graph_final_nch_dep_syst_new_x_axis = rt.TGraphAsymmErrors(3, new_x_axis, near_graph_final_nch_dep_syst.GetY(), new_x_axis_err, new_x_axis_err, near_graph_final_nch_dep_syst.GetEYlow(), near_graph_final_nch_dep_syst.GetEYhigh())
    away_graph_final_nch_dep_syst_new_x_axis = rt.TGraphAsymmErrors(3, new_x_axis, away_graph_final_nch_dep_syst.GetY(), new_x_axis_err, new_x_axis_err, away_graph_final_nch_dep_syst.GetEYlow(), away_graph_final_nch_dep_syst.GetEYhigh())
    ue_graph_final_nch_dep_syst_new_x_axis = rt.TGraphAsymmErrors(3, new_x_axis, ue_graph_final_nch_dep_syst.GetY(), new_x_axis_err, new_x_axis_err, ue_graph_final_nch_dep_syst.GetEYlow(), ue_graph_final_nch_dep_syst.GetEYhigh())
    total_graph_final_nch_dep_syst_new_x_axis = rt.TGraphAsymmErrors(3, new_x_axis, total_graph_final_nch_dep_syst.GetY(), new_x_axis_err, new_x_axis_err, total_graph_final_nch_dep_syst.GetEYlow(), total_graph_final_nch_dep_syst.GetEYhigh())
    hh_near_graph_final_nch_dep_syst_new_x_axis = rt.TGraphAsymmErrors(3, new_x_axis, hh_near_graph_final_nch_dep_syst.GetY(), new_x_axis_err, new_x_axis_err, hh_near_graph_final_nch_dep_syst.GetEYlow(), hh_near_graph_final_nch_dep_syst.GetEYhigh())
    hh_away_graph_final_nch_dep_syst_new_x_axis = rt.TGraphAsymmErrors(3, new_x_axis, hh_away_graph_final_nch_dep_syst.GetY(), new_x_axis_err, new_x_axis_err, hh_away_graph_final_nch_dep_syst.GetEYlow(), hh_away_graph_final_nch_dep_syst.GetEYhigh())
    hh_ue_graph_final_nch_dep_syst_new_x_axis = rt.TGraphAsymmErrors(3, new_x_axis, hh_ue_graph_final_nch_dep_syst.GetY(), new_x_axis_err, new_x_axis_err, hh_ue_graph_final_nch_dep_syst.GetEYlow(), hh_ue_graph_final_nch_dep_syst.GetEYhigh())
    hh_total_graph_final_nch_dep_syst_new_x_axis = rt.TGraphAsymmErrors(3, new_x_axis, hh_total_graph_final_nch_dep_syst.GetY(), new_x_axis_err, new_x_axis_err, hh_total_graph_final_nch_dep_syst.GetEYlow(), hh_total_graph_final_nch_dep_syst.GetEYhigh())
    ...
    near_ratio_graph_final_nch_dep_syst_new_x_axis = rt.TGraphErrors(3, new_x_axis, near_ratio_graph_final_nch_dep_syst.GetY(), new_x_axis_err, near_ratio_graph_final_nch_dep_syst.GetEY())
    away_ratio_graph_final_nch_dep_syst_new_x_axis = rt.TGraphErrors(3, new_x_axis, away_ratio_graph_final_nch_dep_syst.GetY(), new_x_axis_err, away_ratio_graph_final_nch_dep_syst.GetEY())
    ue_ratio_graph_final_nch_dep_syst_new_x_axis = rt.TGraphErrors(3, new_x_axis, ue_ratio_graph_final_nch_dep_syst.GetY(), new_x_axis_err, ue_ratio_graph_final_nch_dep_syst.GetEY())
    total_ratio_graph_final_nch_dep_syst_new_x_axis = rt.TGraphErrors(3, new_x_axis, total_ratio_graph_final_nch_dep_syst.GetY(), new_x_axis_err, total_ratio_graph_final_nch_dep_syst.GetEY())
    ...
    outfile_string = "output/systematics/final_yield_ratio_syst_newnch"
    if PT_MODE == 1:
    ...
    near_graph_final_nch_dep_syst.Write("near_yield_graph_final_nch_dep_syst")
    away_graph_final_nch_dep_syst.Write("away_yield_graph_final_nch_dep_syst")
    ue_graph_final_nch_dep_syst.Write("ue_yield_graph_final_nch_dep_syst")
    total_graph_final_nch_dep_syst.Write("total_yield_graph_final_nch_dep_syst")
    ...
    near_graph_final_nch_dep_syst_new_x_axis.Write("near_yield_graph_final_nch_dep_syst_new_x_axis")
    away_graph_final_nch_dep_syst_new_x_axis.Write("away_yield_graph_final_nch_dep_syst_new_x_axis")
    ue_graph_final_nch_dep_syst_new_x_axis.Write("ue_yield_graph_final_nch_dep_syst_new_x_axis")
    total_graph_final_nch_dep_syst_new_x_axis.Write("total_yield_graph_final_nch_dep_syst_new_x_axis")
    ...
    hh_near_graph_final_nch_dep_syst.Write("hh_near_yield_graph_final_nch_dep_syst")
    hh_away_graph_final_nch_dep_syst.Write("hh_away_yield_graph_final_nch_dep_syst")
    hh_ue_graph_final_nch_dep_syst.Write("hh_ue_yield_graph_final_nch_dep_syst")
    hh_total_graph_final_nch_dep_syst.Write("hh_total_yield_graph_final_nch_dep_syst")
    ...
    hh_near_graph_final_nch_dep_syst_new_x_axis.Write("hh_near_yield_graph_final_nch_dep_syst_new_x_axis")
    hh_away_graph_final_nch_dep_syst_new_x_axis.Write("hh_away_yield_graph_final_nch_dep_syst_new_x_axis")
    hh_ue_graph_final_nch_dep_syst_new_x_axis.Write("hh_ue_yield_graph_final_nch_dep_syst_new_x_axis")
    hh_total_graph_final_nch_dep_syst_new_x_axis.Write("hh_total_yield_graph_final_nch_dep_syst_new_x_axis")
    ...
    near_ratio_graph_final_nch_dep_syst.Write("near_ratio_graph_final_nch_dep_syst")
    away_ratio_graph_final_nch_dep_syst.Write("away_ratio_graph_final_nch_dep_syst")
    ue_ratio_graph_final_nch_dep_syst.Write("ue_ratio_graph_final_nch_dep_syst")
    total_ratio_graph_final_nch_dep_syst.Write("total_ratio_graph_final_nch_dep_syst")
    ...
    near_ratio_graph_final_nch_dep_syst_new_x_axis.Write("near_ratio_graph_final_nch_dep_syst_new_x_axis")
    away_ratio_graph_final_nch_dep_syst_new_x_axis.Write("away_ratio_graph_final_nch_dep_syst_new_x_axis")
    ue_ratio_graph_final_nch_dep_syst_new_x_axis.Write("ue_ratio_graph_final_nch_dep_syst_new_x_axis")
    total_ratio_graph_final_nch_dep_syst_new_x_axis.Write("total_ratio_graph_final_nch_dep_syst_new_x_axis")
