...
for PT_MODE in range(3):
    ...
    ns_hh_technique_syst_hist = rt.TH1D("ns_hh_technique_syst_hist", "", 3, 0, 3)
    ns_hh_technique_syst_hist.SetBinContent(1, ns_hh_technique_rms_0_20)
    ns_hh_technique_syst_hist.SetBinContent(2, ns_hh_technique_rms_20_50)
    ns_hh_technique_syst_hist.SetBinContent(3, ns_hh_technique_rms_50_80)
    ns_hh_technique_syst_hist.SetBinError(1, 0)
    ns_hh_technique_syst_hist.SetBinError(2, 0)
    ns_hh_technique_syst_hist.SetBinError(3, 0)
    ns_hh_technique_syst_hist.SetLineColor(rt.kViolet + 2)
    ns_hh_technique_syst_hist.SetLineWidth(2)
    ...
    as_hh_technique_syst_hist = rt.TH1D("as_hh_technique_syst_hist", "", 3, 0, 3)
    as_hh_technique_syst_hist.SetBinContent(1, as_hh_technique_rms_0_20)
    as_hh_technique_syst_hist.SetBinContent(2, as_hh_technique_rms_20_50)
    as_hh_technique_syst_hist.SetBinContent(3, as_hh_technique_rms_50_80)
    as_hh_technique_syst_hist.SetBinError(1, 0)
    as_hh_technique_syst_hist.SetBinError(2, 0)
    as_hh_technique_syst_hist.SetBinError(3, 0)
    as_hh_technique_syst_hist.SetLineColor(rt.kViolet + 2)
    as_hh_technique_syst_hist.SetLineWidth(2)

    # these syst errors were obtained from random variations, see "random_variations.py"
    if PT_MODE == 1:

        topo_ns_rms = 0.034
        topo_ns_nch_dep_rms = 0.005
        topo_ns_syst_hist = rt.TH1D("topo_ns_syst_hist", "", 3, 0, 3)
        topo_ns_syst_hist.SetBinContent(1, topo_ns_rms)
        topo_ns_syst_hist.SetBinContent(2, topo_ns_rms)
        topo_ns_syst_hist.SetBinContent(3, topo_ns_rms)
        topo_ns_syst_hist.SetBinError(1, 0)
        topo_ns_syst_hist.SetBinError(2, 0)
        topo_ns_syst_hist.SetBinError(3, 0)
        topo_ns_syst_hist.SetLineColor(rt.kRed - 2)
        topo_ns_syst_hist.SetLineWidth(2)
        topo_as_rms = 0.024
        topo_as_nch_dep_rms = 0.005
        topo_as_syst_hist = rt.TH1D("topo_as_syst_hist", "", 3, 0, 3)
        topo_as_syst_hist.SetBinContent(1, topo_as_rms)
        topo_as_syst_hist.SetBinContent(2, topo_as_rms)
        topo_as_syst_hist.SetBinContent(3, topo_as_rms)
        topo_as_syst_hist.SetBinError(1, 0)
        topo_as_syst_hist.SetBinError(2, 0)
        topo_as_syst_hist.SetBinError(3, 0)
        topo_as_syst_hist.SetLineColor(rt.kRed - 2)
        topo_as_syst_hist.SetLineWidth(2)

        topo_ns_hh_rms = 0.021
        topo_ns_hh_nch_dep_rms = 0.005
        topo_ns_hh_syst_hist = rt.TH1D("topo_ns_hh_syst_hist", "", 3, 0, 3)
        topo_ns_hh_syst_hist.SetBinContent(1, topo_ns_hh_rms)
        topo_ns_hh_syst_hist.SetBinContent(2, topo_ns_hh_rms)
        topo_ns_hh_syst_hist.SetBinContent(3, topo_ns_hh_rms)
        topo_ns_hh_syst_hist.SetBinError(1, 0)
        topo_ns_hh_syst_hist.SetBinError(2, 0)
        topo_ns_hh_syst_hist.SetBinError(3, 0)
        topo_ns_hh_syst_hist.SetLineColor(rt.kRed - 2)
        topo_ns_hh_syst_hist.SetLineWidth(2)
        topo_as_hh_rms = 0.030
        topo_as_hh_nch_dep_rms = 0.005
        topo_as_hh_syst_hist = rt.TH1D("topo_as_hh_syst_hist", "", 3, 0, 3)
        topo_as_hh_syst_hist.SetBinContent(1, topo_as_hh_rms)
        topo_as_hh_syst_hist.SetBinContent(2, topo_as_hh_rms)
        topo_as_hh_syst_hist.SetBinContent(3, topo_as_hh_rms)
        topo_as_hh_syst_hist.SetBinError(1, 0)
        topo_as_hh_syst_hist.SetBinError(2, 0)
        topo_as_hh_syst_hist.SetBinError(3, 0)
        topo_as_hh_syst_hist.SetLineColor(rt.kRed - 2)
        topo_as_hh_syst_hist.SetLineWidth(2)
    ...
    ns_total_syst_hist.SetBinContent(1, math.sqrt(ns_sideband_rms_0_20**2 + ns_signal_rms_0_20**2 + ns_pid_rms_0_20**2 + ns_technique_rms_0_20**2 + topo_ns_rms**2))
    ns_total_syst_hist.SetBinContent(2, math.sqrt(ns_sideband_rms_20_50**2 + ns_signal_rms_20_50**2 + ns_pid_rms_20_50**2 + ns_technique_rms_20_50**2 + topo_ns_rms**2))
    ns_total_syst_hist.SetBinContent(3, math.sqrt(ns_sideband_rms_50_80**2 + ns_signal_rms_50_80**2 + ns_pid_rms_50_80**2 + ns_technique_rms_50_80**2 + topo_ns_rms**2))
    ...
    ns_hh_total_syst_hist = rt.TH1D("ns_hh_total_syst_hist", "", 3, 0, 3)
    ns_hh_total_syst_hist.SetBinContent(1, math.sqrt( ns_hh_technique_rms_0_20**2 + topo_ns_hh_rms**2))
    ns_hh_total_syst_hist.SetBinContent(2, math.sqrt( ns_hh_technique_rms_20_50**2 + topo_ns_hh_rms**2))
    ns_hh_total_syst_hist.SetBinContent(3, math.sqrt( ns_hh_technique_rms_50_80**2 + topo_ns_hh_rms**2))
    ns_hh_total_syst_hist.SetBinError(1, 0)
    ns_hh_total_syst_hist.SetBinError(2, 0)
    ns_hh_total_syst_hist.SetBinError(3, 0)
    ns_hh_total_syst_hist.SetLineColor(rt.kBlack)
    ns_hh_total_syst_hist.SetLineWidth(2)
    ns_hh_total_syst_hist.SetTitle("")
    ns_hh_total_syst_hist.GetXaxis().SetBinLabel(1, "0-20%")
    ns_hh_total_syst_hist.GetXaxis().SetBinLabel(2, "20-50%")
    ns_hh_total_syst_hist.GetXaxis().SetBinLabel(3, "50-80%")
    ns_hh_total_syst_hist.GetXaxis().SetTitle("Mult. Percentile")
    ns_hh_total_syst_hist.GetYaxis().SetTitle("Systematic Uncertainty (%)")

    as_total_syst_hist = rt.TH1D("as_total_syst_hist", "", 3, 0, 3)
    as_total_syst_hist.SetBinContent(1, math.sqrt(as_sideband_rms_0_20**2 + as_signal_rms_0_20**2 + as_pid_rms_0_20**2 + as_technique_rms_0_20**2 + topo_as_rms**2))
    as_total_syst_hist.SetBinContent(2, math.sqrt(as_sideband_rms_20_50**2 + as_signal_rms_20_50**2 + as_pid_rms_20_50**2 + as_technique_rms_20_50**2 + topo_as_rms**2))
    as_total_syst_hist.SetBinContent(3, math.sqrt(as_sideband_rms_50_80**2 + as_signal_rms_50_80**2 + as_pid_rms_50_80**2 + as_technique_rms_50_80**2 + topo_as_rms**2))
    ...
    as_hh_total_syst_hist = rt.TH1D("as_hh_total_syst_hist", "", 3, 0, 3)
    as_hh_total_syst_hist.SetBinContent(1, math.sqrt( as_hh_technique_rms_0_20**2 + topo_as_hh_rms**2))
    as_hh_total_syst_hist.SetBinContent(2, math.sqrt( as_hh_technique_rms_20_50**2 + topo_as_hh_rms**2))
    as_hh_total_syst_hist.SetBinContent(3, math.sqrt( as_hh_technique_rms_50_80**2 + topo_as_hh_rms**2))
    as_hh_total_syst_hist.SetBinError(1, 0)
    as_hh_total_syst_hist.SetBinError(2, 0)
    as_hh_total_syst_hist.SetBinError(3, 0)
    as_hh_total_syst_hist.SetLineColor(rt.kBlack)
    as_hh_total_syst_hist.SetLineWidth(2)
    as_hh_total_syst_hist.SetTitle("")
    as_hh_total_syst_hist.GetXaxis().SetBinLabel(1, "0-20%")
    as_hh_total_syst_hist.GetXaxis().SetBinLabel(2, "20-50%")
    as_hh_total_syst_hist.GetXaxis().SetBinLabel(3, "50-80%")
    as_hh_total_syst_hist.GetXaxis().SetTitle("Mult. Percentile")
    as_hh_total_syst_hist.GetYaxis().SetTitle("Systematic Uncertainty (%)")
    ...
    leg.AddEntry(topo_ns_syst_hist, "Topo", "l")
    # leg.AddEntry(matbud_syst_hist, "Mat. budget", "l")
    leg.AddEntry(ns_total_syst_hist, "Total", "l")

    hh_leg = rt.TLegend(0.6, 0.7, 0.9, 0.9)
    hh_leg.SetBorderSize(0)
    hh_leg.SetFillStyle(0)
    hh_leg.AddEntry(ns_hh_technique_syst_hist, "Technique", "l")
    hh_leg.AddEntry(topo_ns_hh_syst_hist, "Assoc.Eff", "l")
    hh_leg.AddEntry(ns_total_syst_hist, "Total", "l")
    ...
    topo_ns_syst_hist.Scale(100)
    ns_hh_total_syst_hist.Scale(100)
    ns_hh_technique_syst_hist.Scale(100)
    topo_ns_hh_syst_hist.Scale(100)
    ...
    topo_as_syst_hist.Scale(100)
    as_hh_total_syst_hist.Scale(100)
    as_hh_technique_syst_hist.Scale(100)
    topo_as_hh_syst_hist.Scale(100)
    ...
    ns_hh_total_syst_hist.GetYaxis().SetRangeUser(0, ns_hh_total_syst_hist.GetMaximum()*1.8)
    as_hh_total_syst_hist.GetYaxis().SetRangeUser(0, as_hh_total_syst_hist.GetMaximum()*1.8)
    ...
    topo_ns_syst_hist.Draw("hist same")
    ...
    topo_as_syst_hist.Draw("hist same")
    # matbud_syst_hist.Draw("hist same")
    leg.Draw("SAME")
    if PT_MODE == 0:
    ...
    ns_hh_total_syst_hist.Draw("hist")
    ns_hh_technique_syst_hist.Draw("hist same")
    topo_ns_hh_syst_hist.Draw("hist same")
    # matbud_syst_hist.Draw("hist same")
    hh_leg.Draw("SAME")
    if PT_MODE == 0:
        c.SaveAs("../figures/systematics_ns_hh_width_postbarlow.pdf")
    elif PT_MODE == 1:
        c.SaveAs("../figures/systematics_ns_hh_width_postbarlow_lowpt.pdf")
    elif PT_MODE == 2:
        c.SaveAs("../figures/systematics_ns_hh_width_postbarlow_highpt.pdf")

    as_hh_total_syst_hist.Draw("hist")
    as_hh_technique_syst_hist.Draw("hist same")
    topo_as_hh_syst_hist.Draw("hist same")
    # matbud_syst_hist.Draw("hist same")
    hh_leg.Draw("SAME")
    if PT_MODE == 0:
        c.SaveAs("../figures/systematics_as_hh_width_postbarlow.pdf")
    elif PT_MODE == 1:
        c.SaveAs("../figures/systematics_as_hh_width_postbarlow_lowpt.pdf")
    elif PT_MODE == 2:
        c.SaveAs("../figures/systematics_as_hh_width_postbarlow_highpt.pdf")
    ...
    hh_ns_total_syst_0_20 = ns_hh_total_syst_hist.GetBinContent(1)/100
    hh_ns_total_syst_20_50 = ns_hh_total_syst_hist.GetBinContent(2)/100
    hh_ns_total_syst_50_80 = ns_hh_total_syst_hist.GetBinContent(3)/100

    hh_as_total_syst_0_20 = as_hh_total_syst_hist.GetBinContent(1)/100
    hh_as_total_syst_20_50 = as_hh_total_syst_hist.GetBinContent(2)/100
    hh_as_total_syst_50_80 = as_hh_total_syst_hist.GetBinContent(3)/100

    
    print(f"------------PT MODE: {PT_MODE}----------------")
    print("h-Lambda")
    print(f"0-20\% & Near & {ns_signal_syst_hist.GetBinContent(1):.2f} & {ns_sideband_syst_hist.GetBinContent(1):.2f} & {ns_pid_syst_hist.GetBinContent(1):.2f} & {ns_technique_syst_hist.GetBinContent(1):.2f} & {topo_ns_syst_hist.GetBinContent(1):.2f} &  {ns_total_syst_hist.GetBinContent(1):.2f} \\\\")
    print(f"20-50\% & Near & {ns_signal_syst_hist.GetBinContent(2):.2f} & {ns_sideband_syst_hist.GetBinContent(2):.2f} & {ns_pid_syst_hist.GetBinContent(2):.2f} & {ns_technique_syst_hist.GetBinContent(2):.2f} & {topo_ns_syst_hist.GetBinContent(2):.2f} &  {ns_total_syst_hist.GetBinContent(2):.2f} \\\\")
    print(f"50-80\% & Near & {ns_signal_syst_hist.GetBinContent(3):.2f} & {ns_sideband_syst_hist.GetBinContent(3):.2f} & {ns_pid_syst_hist.GetBinContent(3):.2f} & {ns_technique_syst_hist.GetBinContent(3):.2f} & {topo_ns_syst_hist.GetBinContent(3):.2f} &  {ns_total_syst_hist.GetBinContent(3):.2f} \\\\")
    print(f"0-20\% & Away & {as_signal_syst_hist.GetBinContent(1):.2f} & {as_sideband_syst_hist.GetBinContent(1):.2f} & {as_pid_syst_hist.GetBinContent(1):.2f} & {as_technique_syst_hist.GetBinContent(1):.2f} & {topo_as_syst_hist.GetBinContent(1):.2f} &  {as_total_syst_hist.GetBinContent(1):.2f} \\\\")
    print(f"20-50\% & Away & {as_signal_syst_hist.GetBinContent(2):.2f} & {as_sideband_syst_hist.GetBinContent(2):.2f} & {as_pid_syst_hist.GetBinContent(2):.2f} & {as_technique_syst_hist.GetBinContent(2):.2f} & {topo_as_syst_hist.GetBinContent(2):.2f} &  {as_total_syst_hist.GetBinContent(2):.2f} \\\\")
    print(f"50-80\% & Away & {as_signal_syst_hist.GetBinContent(3):.2f} & {as_sideband_syst_hist.GetBinContent(3):.2f} & {as_pid_syst_hist.GetBinContent(3):.2f} & {as_technique_syst_hist.GetBinContent(3):.2f} & {topo_as_syst_hist.GetBinContent(3):.2f} &  {as_total_syst_hist.GetBinContent(3):.2f} \\\\")
    print("h-h")
    print(f"0-20\% & Near & {ns_hh_technique_rms_0_20*100:.2f} & {topo_ns_hh_rms*100:.2f} & {hh_ns_total_syst_0_20*100:.2f} \\\\")
    print(f"20-50\% & Near & {ns_hh_technique_rms_20_50*100:.2f} & {topo_ns_hh_rms*100:.2f} & {hh_ns_total_syst_20_50*100:.2f} \\\\")
    print(f"50-80\% & Near & {ns_hh_technique_rms_50_80*100:.2f} & {topo_ns_hh_rms*100:.2f} & {hh_ns_total_syst_50_80*100:.2f} \\\\")
    print(f"0-20\% & Away & {as_hh_technique_rms_0_20*100:.2f} & {topo_as_hh_rms*100:.2f} & {hh_as_total_syst_0_20*100:.2f} \\\\")
    print(f"20-50\% & Away & {as_hh_technique_rms_20_50*100:.2f} & {topo_as_hh_rms*100:.2f} & {hh_as_total_syst_20_50*100:.2f} \\\\")
    print(f"50-80\% & Away & {as_hh_technique_rms_50_80*100:.2f} & {topo_as_hh_rms*100:.2f} & {hh_as_total_syst_50_80*100:.2f} \\\\")
