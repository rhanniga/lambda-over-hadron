...
for PT_MODE in range(3):
    ...
    leg.Draw("SAME")
    if PT_MODE == 0:
        c.SaveAs("../figures/systematics_ns_width_prebarlow.pdf")
    elif PT_MODE == 1:
        c.SaveAs("../figures/systematics_ns_width_prebarlow_lowpt.pdf")
    elif PT_MODE == 2:
        c.SaveAs("../figures/systematics_ns_width_prebarlow_highpt.pdf")
    ...
    leg.Draw("SAME")
    if PT_MODE == 0:
        c.SaveAs("../figures/systematics_as_width_prebarlow.pdf")
    elif PT_MODE == 1:
        c.SaveAs("../figures/systematics_as_width_prebarlow_lowpt.pdf")
    elif PT_MODE == 2:
        c.SaveAs("../figures/systematics_as_width_prebarlow_highpt.pdf")
    ...
    print("h-Lambda")
    print(f"0-20\% & Near & {ns_signal_syst_hist.GetBinContent(1):.2f} & {ns_sideband_syst_hist.GetBinContent(1):.2f} & {ns_pid_syst_hist.GetBinContent(1):.2f} & {ns_technique_syst_hist.GetBinContent(1):.2f} & {topo_syst_hist.GetBinContent(1):.2f} & {matbud_syst_hist.GetBinContent(1):.2f} & {ns_total_syst_hist.GetBinContent(1):.2f} \\\\")
    print(f"20-50\% & Near & {ns_signal_syst_hist.GetBinContent(2):.2f} & {ns_sideband_syst_hist.GetBinContent(2):.2f} & {ns_pid_syst_hist.GetBinContent(2):.2f} & {ns_technique_syst_hist.GetBinContent(2):.2f} & {topo_syst_hist.GetBinContent(2):.2f} & {matbud_syst_hist.GetBinContent(2):.2f} & {ns_total_syst_hist.GetBinContent(2):.2f} \\\\")
    print(f"50-80\% & Near & {ns_signal_syst_hist.GetBinContent(3):.2f} & {ns_sideband_syst_hist.GetBinContent(3):.2f} & {ns_pid_syst_hist.GetBinContent(3):.2f} & {ns_technique_syst_hist.GetBinContent(3):.2f} & {topo_syst_hist.GetBinContent(3):.2f} & {matbud_syst_hist.GetBinContent(3):.2f} & {ns_total_syst_hist.GetBinContent(3):.2f} \\\\")
    print(f"0-20\% & Away & {as_signal_syst_hist.GetBinContent(1):.2f} & {as_sideband_syst_hist.GetBinContent(1):.2f} & {as_pid_syst_hist.GetBinContent(1):.2f} & {as_technique_syst_hist.GetBinContent(1):.2f} & {topo_syst_hist.GetBinContent(1):.2f} & {matbud_syst_hist.GetBinContent(1):.2f} & {as_total_syst_hist.GetBinContent(1):.2f} \\\\")
    print(f"20-50\% & Away & {as_signal_syst_hist.GetBinContent(2):.2f} & {as_sideband_syst_hist.GetBinContent(2):.2f} & {as_pid_syst_hist.GetBinContent(2):.2f} & {as_technique_syst_hist.GetBinContent(2):.2f} & {topo_syst_hist.GetBinContent(2):.2f} & {matbud_syst_hist.GetBinContent(2):.2f} & {as_total_syst_hist.GetBinContent(2):.2f} \\\\")
    print(f"50-80\% & Away & {as_signal_syst_hist.GetBinContent(3):.2f} & {as_sideband_syst_hist.GetBinContent(3):.2f} & {as_pid_syst_hist.GetBinContent(3):.2f} & {as_technique_syst_hist.GetBinContent(3):.2f} & {topo_syst_hist.GetBinContent(3):.2f} & {matbud_syst_hist.GetBinContent(3):.2f} & {as_total_syst_hist.GetBinContent(3):.2f} \\\\")
    print("h-h")
    print(f"0-20\% & Near & {ns_hh_technique_rms_0_20*100:.2f} & {3.5} & {hh_ns_total_syst_0_20*100:.2f} \\\\")
    print(f"20-50\% & Near & {ns_hh_technique_rms_20_50*100:.2f} & {3.5} & {hh_ns_total_syst_20_50*100:.2f} \\\\")
    print(f"50-80\% & Near & {ns_hh_technique_rms_50_80*100:.2f} & {3.5} & {hh_ns_total_syst_50_80*100:.2f} \\\\")
    print(f"0-20\% & Away & {as_hh_technique_rms_0_20*100:.2f} & {3.5} & {hh_as_total_syst_0_20*100:.2f} \\\\")
    print(f"20-50\% & Away & {as_hh_technique_rms_20_50*100:.2f} & {3.5} & {hh_as_total_syst_20_50*100:.2f} \\\\")
    print(f"50-80\% & Away & {as_hh_technique_rms_50_80*100:.2f} & {3.5} & {hh_as_total_syst_50_80*100:.2f} \\\\")