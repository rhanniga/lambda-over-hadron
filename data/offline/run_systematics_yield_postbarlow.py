...
def make_dumb_plot(near_ratios, away_ratios, ue_ratios, name):
    ...
    central_h.GetYaxis().SetRangeUser(-0.6, 0.6)
...
total_nch_dep_dphi_sys_20_50 = 0.0097
...
near_yield_0_20_nch_dep_systematic = math.sqrt(r_0_20**2 + total_nch_dep_dphi_sys_0_20**2)
near_yield_20_50_nch_dep_systematic = math.sqrt(r_20_50**2 + total_nch_dep_dphi_sys_20_50**2)
near_yield_50_80_nch_dep_systematic = math.sqrt(r_50_80**2 + total_nch_dep_dphi_sys_50_80**2)
...
away_yield_0_20_nch_dep_systematic = math.sqrt(r_0_20**2 + total_nch_dep_dphi_sys_0_20**2)
away_yield_20_50_nch_dep_systematic = math.sqrt(r_20_50**2 + total_nch_dep_dphi_sys_20_50**2)
away_yield_50_80_nch_dep_systematic = math.sqrt(r_50_80**2 + total_nch_dep_dphi_sys_50_80**2)
...
hh_near_yield_0_20_nch_dep_systematic = math.sqrt(r_0_20**2 + hh_total_nch_dep_dphi_sys_0_20**2)
hh_near_yield_20_50_nch_dep_systematic = math.sqrt(r_20_50**2 + hh_total_nch_dep_dphi_sys_20_50**2)
hh_near_yield_50_80_nch_dep_systematic = math.sqrt(r_50_80**2 + hh_total_nch_dep_dphi_sys_50_80**2)
...
hh_away_yield_0_20_nch_dep_systematic = math.sqrt(r_0_20**2 + hh_total_nch_dep_dphi_sys_0_20**2)
hh_away_yield_20_50_nch_dep_systematic = math.sqrt(r_20_50**2 + hh_total_nch_dep_dphi_sys_20_50**2)
hh_away_yield_50_80_nch_dep_systematic = math.sqrt(r_50_80**2 + hh_total_nch_dep_dphi_sys_50_80**2)
...
print(h_lambda_near_ratios_0_20)
...
print(h_lambda_near_ratios_20_50)
...
outfile_string = "output/systematics/final_yield_ratio_syst"
if LOW_PT:
