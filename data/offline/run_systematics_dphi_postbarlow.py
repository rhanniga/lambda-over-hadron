...
for PT_MODE in range(3):
    ...
    if PT_MODE == 0:
        ...
        c.SaveAs("figures/systematics_dphi_postbarlow_lowpt.pdf")
    elif PT_MODE == 2:
        c.SaveAs("figures/systematics_dphi_postbarlow_highpt.pdf")
    ...
    c.SetTopMargin(0.05)
    sideband_syst_hist = rt.TH1D("sideband_syst_hist", "", 3, 0, 3)
    sideband_syst_hist.SetBinContent(1, sideband_nch_dep_rms_0_20)
    sideband_syst_hist.SetBinContent(2, sideband_nch_dep_rms_20_50)
    sideband_syst_hist.SetBinContent(3, sideband_nch_dep_rms_50_80)
    sideband_syst_hist.SetBinError(1, 0)
    sideband_syst_hist.SetBinError(2, 0)
    sideband_syst_hist.SetBinError(3, 0)
    sideband_syst_hist.SetLineColor(rt.kGreen - 2)
    sideband_syst_hist.SetLineWidth(2)
    signal_syst_hist = rt.TH1D("signal_syst_hist", "", 3, 0, 3)
    signal_syst_hist.SetBinContent(1, signal_nch_dep_rms_0_20)
    signal_syst_hist.SetBinContent(2, signal_nch_dep_rms_20_50)
    signal_syst_hist.SetBinContent(3, signal_nch_dep_rms_50_80)
    signal_syst_hist.SetBinError(1, 0)
    signal_syst_hist.SetBinError(2, 0)
    signal_syst_hist.SetBinError(3, 0)
    signal_syst_hist.SetLineColor(rt.kMagenta - 2)
    signal_syst_hist.SetLineWidth(2)
    pid_syst_hist = rt.TH1D("pid_syst_hist", "", 3, 0, 3)
    pid_syst_hist.SetBinContent(1, pid_nch_dep_rms_0_20)
    pid_syst_hist.SetBinContent(2, pid_nch_dep_rms_20_50)
    pid_syst_hist.SetBinContent(3, pid_nch_dep_rms_50_80)
    pid_syst_hist.SetBinError(1, 0)
    pid_syst_hist.SetBinError(2, 0)
    pid_syst_hist.SetBinError(3, 0)
    pid_syst_hist.SetLineColor(rt.kAzure - 2)
    ...
    if PT_MODE == 1:
        topo_nch_dep_rms = 0.005
        topo_syst_hist = rt.TH1D("topo_syst_hist", "", 3, 0, 3)
        topo_syst_hist.SetBinContent(1, topo_nch_dep_rms)
        topo_syst_hist.SetBinContent(2, topo_nch_dep_rms)
        topo_syst_hist.SetBinContent(3, topo_nch_dep_rms)
        topo_syst_hist.SetBinError(1, 0)
        topo_syst_hist.SetBinError(2, 0)
        topo_syst_hist.SetBinError(3, 0)
        topo_syst_hist.SetLineColor(rt.kRed - 2)
    ...
    total_nch_dep_syst_hist = rt.TH1D("total_nch_dep_syst_hist", "", 3, 0, 3)
    total_nch_dep_syst_hist.SetBinContent(1, math.sqrt(sideband_nch_dep_rms_0_20**2 + signal_nch_dep_rms_0_20**2 + pid_nch_dep_rms_0_20**2 + topo_nch_dep_rms**2))
    total_nch_dep_syst_hist.SetBinContent(2, math.sqrt(sideband_nch_dep_rms_20_50**2 + signal_nch_dep_rms_20_50**2 + pid_nch_dep_rms_20_50**2 + topo_nch_dep_rms**2))
    total_nch_dep_syst_hist.SetBinContent(3, math.sqrt(sideband_nch_dep_rms_50_80**2 + signal_nch_dep_rms_50_80**2 + pid_nch_dep_rms_50_80**2 + topo_nch_dep_rms**2))
    total_nch_dep_syst_hist.SetBinError(1, 0)
    total_nch_dep_syst_hist.SetBinError(2, 0)
    total_nch_dep_syst_hist.SetBinError(3, 0)
    total_nch_dep_syst_hist.SetLineColor(rt.kGray + 2)
    total_nch_dep_syst_hist.SetLineWidth(2)
    total_nch_dep_syst_hist.SetTitle("")
    total_nch_dep_syst_hist.GetXaxis().SetBinLabel(1, "0-20%")
    total_nch_dep_syst_hist.GetXaxis().SetBinLabel(2, "20-50%")
    total_nch_dep_syst_hist.GetXaxis().SetBinLabel(3, "50-80%")
    total_nch_dep_syst_hist.GetXaxis().SetTitle("Mult. Percentile")
    total_nch_dep_syst_hist.GetYaxis().SetTitle("Mult. Uncor. Systematic Uncertainty (%)")

    leg = rt.TLegend(0.6, 0.7, 0.9, 0.9)
    leg.SetBorderSize(0)
    leg.SetFillStyle(0)
    leg.AddEntry(sideband_syst_hist, "Uncor Sideband", "l")
    ...
    total_syst_hist.Scale(100)
    total_nch_dep_syst_hist.Scale(100)
    sideband_syst_hist.Scale(100)
    signal_syst_hist.Scale(100)
    pid_syst_hist.Scale(100)
    topo_syst_hist.Scale(100)
    ...
    total_syst_hist.Draw("hist")
    total_nch_dep_syst_hist.Draw("hist same")
    sideband_syst_hist.Draw("hist same")
    signal_syst_hist.Draw("hist same")
    pid_syst_hist.Draw("hist same")
    topo_syst_hist.Draw("hist same")
    ...
    if PT_MODE == 0:
        ...
        c.SaveAs("figures/nch_dep_systematics_dphi_postbarlow_lowpt.pdf")
    elif PT_MODE == 2:
        c.SaveAs("figures/nch_dep_systematics_dphi_postbarlow_highpt.pdf")
