...
for i, f in enumerate([normal_pt_infile, low_pt_infile, high_pt_infile]):
    ...
    h_h_near_width_graph_new_x_axis.SetLineColor(rt.kRed+3)
    ...
    h_h_near_width_graph_new_x_axis.SetMarkerColor(rt.kRed+3)
    h_h_near_width_graph_new_x_axis_dpmjet.SetLineColor(rt.kRed+3)
    ...
    h_h_near_width_graph_new_x_axis_dpmjet.SetFillColor(rt.kRed+3)
    ...
    h_h_near_width_graph_new_x_axis_syst.SetMarkerColor(rt.kRed+3)
    h_h_near_width_graph_new_x_axis_syst.SetLineColor(rt.kRed+3)
    ...
    h_h_away_width_graph_new_x_axis.SetLineColor(rt.kViolet - 6)
    ...
    h_h_away_width_graph_new_x_axis.SetMarkerColor(rt.kViolet - 6)
    h_h_away_width_graph_new_x_axis_dpmjet.SetLineColor(rt.kViolet-6)
    ...
    h_h_away_width_graph_new_x_axis_dpmjet.SetFillColor(rt.kViolet-6)
    ...
    h_h_away_width_graph_new_x_axis_syst.SetMarkerColor(rt.kViolet - 6)
    h_h_away_width_graph_new_x_axis_syst.SetLineColor(rt.kViolet - 6)
    ...
    h_lambda_near_width_graph_new_x_axis.SetLineColor(rt.kOrange-1)
    h_lambda_near_width_graph_new_x_axis.SetLineWidth(2)
    h_lambda_near_width_graph_new_x_axis.SetMarkerStyle(43)
    h_lambda_near_width_graph_new_x_axis.SetMarkerSize(2.5)
    h_lambda_near_width_graph_new_x_axis.SetMarkerColor(rt.kOrange-1)
    h_lambda_near_width_graph_new_x_axis_dpmjet.SetLineColor(rt.kOrange-1)
    ...
    h_lambda_near_width_graph_new_x_axis_dpmjet.SetFillColor(rt.kOrange-1)
    ...
    h_lambda_near_width_graph_new_x_axis_syst.SetMarkerColor(rt.kOrange-1)
    h_lambda_near_width_graph_new_x_axis_syst.SetLineColor(rt.kOrange-1)
    ...
    h_lambda_away_width_graph_new_x_axis.SetLineColor(rt.kAzure-1)
    h_lambda_away_width_graph_new_x_axis.SetLineWidth(2)
    h_lambda_away_width_graph_new_x_axis.SetMarkerStyle(43)
    h_lambda_away_width_graph_new_x_axis.SetMarkerSize(2.5)
    h_lambda_away_width_graph_new_x_axis.SetMarkerColor(rt.kAzure-1)
    h_lambda_away_width_graph_new_x_axis_dpmjet.SetLineColor(rt.kAzure-1)
    ...
    h_lambda_away_width_graph_new_x_axis_dpmjet.SetFillColor(rt.kAzure-1)
    ...
    h_lambda_away_width_graph_new_x_axis_syst.SetMarkerColor(rt.kAzure-1)
    h_lambda_away_width_graph_new_x_axis_syst.SetLineColor(rt.kAzure-1)
    ...
    h_lambda_near_width_graph_comparison_dpmjet.SetLineColor(rt.kOrange-1)
    ...
    h_lambda_near_width_graph_comparison_dpmjet.SetFillColor(rt.kOrange-1)
    ...
    h_lambda_away_width_graph_comparison_dpmjet.SetLineColor(rt.kAzure-1)
    ...
    h_lambda_away_width_graph_comparison_dpmjet.SetFillColor(rt.kAzure-1)
    ...
    h_h_near_width_graph_comparison_dpmjet.SetLineColor(rt.kRed+3)
    ...
    h_h_near_width_graph_comparison_dpmjet.SetFillColor(rt.kRed+3)
    ...
    h_h_away_width_graph_comparison_dpmjet.SetLineColor(rt.kViolet-6)
    ...
    h_h_away_width_graph_comparison_dpmjet.SetFillColor(rt.kViolet-6)
    ...
    h_lambda_near_width_graph_new_x_axis_comparison_dpmjet.SetLineColor(rt.kOrange-1)
    ...
    h_lambda_near_width_graph_new_x_axis_comparison_dpmjet.SetFillColor(rt.kOrange-1)
    ...
    h_lambda_away_width_graph_new_x_axis_comparison_dpmjet.SetLineColor(rt.kAzure-1)
    ...
    h_lambda_away_width_graph_new_x_axis_comparison_dpmjet.SetFillColor(rt.kAzure-1)
    ...
    h_h_near_width_graph_new_x_axis_comparison_dpmjet.SetLineColor(rt.kRed+3)
    ...
    h_h_near_width_graph_new_x_axis_comparison_dpmjet.SetFillColor(rt.kRed+3)
    ...
    h_h_away_width_graph_new_x_axis_comparison_dpmjet.SetLineColor(rt.kViolet-6)
    ...
    h_h_away_width_graph_new_x_axis_comparison_dpmjet.SetFillColor(rt.kViolet-6)
    ...
    h_lambda_near_width_fit.SetLineColor(rt.kOrange - 1)
    ...
    h_lambda_away_width_fit.SetLineColor(rt.kAzure - 1)
    ...
    h_h_near_width_fit.SetLineColor(rt.kRed + 3)
    ...
    h_h_away_width_fit.SetLineColor(rt.kViolet - 6)
    ...
    if i == 1:
        ...
        legend.AddEntry(h_lambda_near_width_graph_new_x_axis, "h-#Lambda, near-side", "PL")
        legend.AddEntry(h_lambda_away_width_graph_new_x_axis, "h-#Lambda, away-side", "PL")
        legend.AddEntry(h_h_near_width_graph_new_x_axis, "h-h, near-side", "PL")
        legend.AddEntry(h_h_away_width_graph_new_x_axis, "h-h, away-side", "PL")
        legend.Draw("SAME")
        dpmjet_legend = rt.TLegend(0.1, 0.7, 0.4, 0.78)
