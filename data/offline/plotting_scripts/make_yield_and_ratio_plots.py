    ...
    for use_new_x_axis in [True, False]:
        for lambda_phi_ratio in [True, False]:
            ...
            if use_new_x_axis:
                ...
                print("#########################################################################")
                print(f"PT MODE: {PT_MODE}, lambda_phi_ratio: {lambda_phi_ratio}")
                print(f"Near fit slope: {near_fit.GetParameter(1)} +/- {near_fit.GetParError(1)}")
                print(f"Away fit slope: {away_fit.GetParameter(1)} +/- {away_fit.GetParError(1)}")
                print(f"UE fit slope: {ue_fit.GetParameter(1)} +/- {ue_fit.GetParError(1)}")
                print("#########################################################################")
            ...
            hh_near_graph_final_syst.SetLineColor(DIHADRON_NEAR_COLOR)
            hh_near_graph_final_syst.SetFillColor(DIHADRON_NEAR_COLOR)
            ...
            hh_near_graph.SetMarkerColor(DIHADRON_NEAR_COLOR)
            hh_near_graph.SetLineColor(DIHADRON_NEAR_COLOR)
            hh_near_graph.SetFillColor(DIHADRON_NEAR_COLOR)
            ...
            hh_near_graph_dpmjet.SetMarkerColor(DIHADRON_NEAR_COLOR)
            hh_near_graph_dpmjet.SetLineColor(DIHADRON_NEAR_COLOR)
            hh_near_graph_dpmjet.SetLineStyle(7)
            hh_near_graph_dpmjet.SetFillColor(DIHADRON_NEAR_COLOR)
            hh_near_graph_dpmjet.SetFillStyle(3144)
            hh_near_graph_dpmjet.SetFillColorAlpha(DIHADRON_NEAR_COLOR, 0.5)
            ...
            hh_near_comparison_graph_dpmjet.SetMarkerColor(DIHADRON_NEAR_COLOR)
            hh_near_comparison_graph_dpmjet.SetLineColor(DIHADRON_NEAR_COLOR)
            hh_near_comparison_graph_dpmjet.SetFillColor(DIHADRON_NEAR_COLOR)
            ...
            near_graph_final_syst.SetFillColor(LAMBDA_NEAR_COLOR)
            near_graph_final_syst.SetLineColor(LAMBDA_NEAR_COLOR)
            ...
            near_graph.SetMarkerColor(LAMBDA_NEAR_COLOR)
            near_graph.SetLineColor(LAMBDA_NEAR_COLOR)
            near_graph.SetFillColor(LAMBDA_NEAR_COLOR)
            ...
            near_graph_dpmjet.SetMarkerColor(LAMBDA_NEAR_COLOR)
            near_graph_dpmjet.SetLineColor(LAMBDA_NEAR_COLOR)
            near_graph_dpmjet.SetLineStyle(7)
            near_graph_dpmjet.SetFillColor(LAMBDA_NEAR_COLOR)
            near_graph_dpmjet.SetFillColorAlpha(LAMBDA_NEAR_COLOR, 0.5)
            ...
            near_comparison_graph_dpmjet.SetMarkerColor(LAMBDA_NEAR_COLOR)
            near_comparison_graph_dpmjet.SetLineColor(LAMBDA_NEAR_COLOR)
            near_comparison_graph_dpmjet.SetFillColor(LAMBDA_NEAR_COLOR)
            ...
            hh_away_graph_final_syst.SetLineColor(DIHADRON_AWAY_COLOR)
            hh_away_graph_final_syst.SetFillColor(DIHADRON_AWAY_COLOR)
            hh_away_graph_final_syst.SetFillStyle(0)

            hh_away_graph.SetMarkerStyle(20)
            hh_away_graph.SetMarkerSize(1.5)
            hh_away_graph.SetMarkerColor(DIHADRON_AWAY_COLOR)
            hh_away_graph.SetLineColor(DIHADRON_AWAY_COLOR)
            hh_away_graph.SetLineWidth(2)
            hh_away_graph.SetFillColor(DIHADRON_AWAY_COLOR)
            hh_away_graph.SetFillStyle(3244)

            hh_away_graph_dpmjet.SetMarkerStyle(20)
            hh_away_graph_dpmjet.SetMarkerSize(0)
            hh_away_graph_dpmjet.SetMarkerColor(DIHADRON_AWAY_COLOR)
            hh_away_graph_dpmjet.SetLineColor(DIHADRON_AWAY_COLOR)
            hh_away_graph_dpmjet.SetLineWidth(0)
            hh_away_graph_dpmjet.SetLineStyle(7)
            hh_away_graph_dpmjet.SetFillColor(DIHADRON_AWAY_COLOR)
            hh_away_graph_dpmjet.SetFillStyle(3144)
            hh_away_graph_dpmjet.SetFillColorAlpha(DIHADRON_AWAY_COLOR, 0.5)

            hh_away_comparison_graph_dpmjet.SetMarkerStyle(20)
            hh_away_comparison_graph_dpmjet.SetMarkerSize(1)
            hh_away_comparison_graph_dpmjet.SetMarkerColor(DIHADRON_AWAY_COLOR)
            hh_away_comparison_graph_dpmjet.SetLineColor(DIHADRON_AWAY_COLOR)
            hh_away_comparison_graph_dpmjet.SetLineWidth(2)
            hh_away_comparison_graph_dpmjet.SetFillColor(DIHADRON_AWAY_COLOR)
            ...
            away_graph_final_syst.SetLineColor(LAMBDA_AWAY_COLOR)
            away_graph_final_syst.SetFillColor(LAMBDA_AWAY_COLOR)
            away_graph_final_syst.SetFillStyle(0)

            away_graph.SetMarkerStyle(21)
            away_graph.SetMarkerSize(1.5)
            away_graph.SetMarkerColor(LAMBDA_AWAY_COLOR)
            away_graph.SetLineColor(LAMBDA_AWAY_COLOR)
            away_graph.SetLineWidth(2)
            away_graph.SetFillColor(LAMBDA_AWAY_COLOR)
            away_graph.SetFillStyle(3144)

            away_graph_dpmjet.SetMarkerStyle(21)
            away_graph_dpmjet.SetMarkerSize(0)
            away_graph_dpmjet.SetMarkerColor(LAMBDA_AWAY_COLOR)
            away_graph_dpmjet.SetLineColor(LAMBDA_AWAY_COLOR)
            away_graph_dpmjet.SetLineWidth(0)
            away_graph_dpmjet.SetLineStyle(7)
            away_graph_dpmjet.SetFillColor(LAMBDA_AWAY_COLOR)
            away_graph_dpmjet.SetFillColorAlpha(LAMBDA_AWAY_COLOR, 0.5)
            ...
            away_comparison_graph_dpmjet.SetMarkerColor(LAMBDA_AWAY_COLOR)
            away_comparison_graph_dpmjet.SetLineColor(LAMBDA_AWAY_COLOR)
            away_comparison_graph_dpmjet.SetLineWidth(2)
            away_comparison_graph_dpmjet.SetFillColor(LAMBDA_AWAY_COLOR)
            ...
            if use_new_x_axis:
                ...
                hh_near_graph_final_nch_dep_syst.SetLineColor(DIHADRON_NEAR_COLOR)
                hh_near_graph_final_nch_dep_syst.SetFillColor(DIHADRON_NEAR_COLOR)
                ...
                hh_away_graph_final_nch_dep_syst.SetLineColor(DIHADRON_AWAY_COLOR)
                hh_away_graph_final_nch_dep_syst.SetFillColor(DIHADRON_AWAY_COLOR)
                ...
                near_graph_final_nch_dep_syst.SetLineColor(LAMBDA_NEAR_COLOR)
                near_graph_final_nch_dep_syst.SetFillColor(LAMBDA_NEAR_COLOR)
                ...
                away_graph_final_nch_dep_syst.SetLineColor(LAMBDA_AWAY_COLOR)
                away_graph_final_nch_dep_syst.SetFillColor(LAMBDA_AWAY_COLOR)
            ...
            if use_new_x_axis:
                ...
                near_fit.SetLineColor(LAMBDA_NEAR_COLOR)
                near_fit.SetLineWidth(2)
                near_fit.SetLineStyle(2)
                away_fit.SetLineColor(LAMBDA_AWAY_COLOR)
                away_fit.SetLineWidth(2)
                away_fit.SetLineStyle(2)

                hh_near_fit.SetLineColor(DIHADRON_NEAR_COLOR)
                hh_near_fit.SetLineWidth(2)
                hh_near_fit.SetLineStyle(2)
                hh_away_fit.SetLineColor(DIHADRON_AWAY_COLOR)
            ...
            if PT_MODE != 0:
                ...
                new_legend = rt.TLegend(0.50, 0.50, 0.97, 0.90)
                new_legend.SetBorderSize(0)
                new_legend.SetFillStyle(0)
                ...
                dpmjet_legend = rt.TLegend(0.15, 0.45, 0.4, 0.7)
                dpmjet_legend.SetBorderSize(0)
                dpmjet_legend.SetFillStyle(0)
                dpmjet_legend.AddEntry(tmp, "DPMJET", "f")
                ...
                if do_model_ratio:
                    ...
                    if PT_MODE == 1:
                        ...
                        h_h_label = rt.TLatex()
                        h_h_label.SetNDC()
                        h_h_label.SetTextSize(0.1)
                        h_h_label.SetTextAlign(13)
                        h_h_label.DrawLatex(0.4, 0.88, "#bf{h-h}")
                        h_lambda_label = rt.TLatex()
                        h_lambda_label.SetNDC()
                        h_lambda_label.SetTextSize(0.1)
                        h_lambda_label.SetTextAlign(13)
                        h_lambda_label.DrawLatex(0.4, 0.55, "#bf{h-#Lambda}")
                        ...
                        h_h_label.SetTextSize(0.1)
                        h_h_label.SetTextAlign(13)
                        h_h_label.DrawLatex(0.22, 0.91, "#bf{h-h}")

                        h_lambda_label = rt.TLatex()
                        h_lambda_label.SetNDC()
                        h_lambda_label.SetTextSize(0.1)
                        h_lambda_label.SetTextAlign(13)
                        h_lambda_label.DrawLatex(0.22, 0.6, "#bf{h-#Lambda}")
