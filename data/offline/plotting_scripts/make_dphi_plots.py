...
for PT_MODE in [0, 1, 2]:
    ...
    pt_label_x_start = 0.23
    pt_label_y_start = 0.85
    ...
    if PT_MODE == 0:
        pt_data_label.DrawLatex(pt_label_x_start, pt_label_y_start - pt_label_text_space, "#bf{2.0 <   #it{p}^{#Lambda}_{T,assoc} < 4.0 GeV/#it{c}}")
    elif PT_MODE == 1:
        pt_data_label.DrawLatex(pt_label_x_start, pt_label_y_start - pt_label_text_space, "#bf{1.5 <   #it{p}^{#Lambda}_{T,assoc} < 2.5 GeV/#it{c}}")
    elif PT_MODE == 2:
    ...
    marker_legend.AddEntry(legend_marker, " h#minus#Lambda data", "lep")
    ...
    v0_ue_line_0_20.SetParameter(0, v0_ue_line_0_20.GetParameter(0)/hh_bin_width)
    v0_ue_line_20_50.SetParameter(0, v0_ue_line_20_50.GetParameter(0)/hh_bin_width)
    v0_ue_line_50_80.SetParameter(0, v0_ue_line_50_80.GetParameter(0)/hh_bin_width)
    ...
    hh_central_dphi_0_20_just_syst.GetYaxis().SetRangeUser(0, MAX_Y_RANGE)
    ...
    hh_central_dphi_20_50_just_syst.GetYaxis().SetRangeUser(0, MAX_Y_RANGE)
    ...
    if PT_MODE == 0:
        ...
        pt_data_label.DrawLatex(pt_label_x_start, pt_label_y_start - pt_label_text_space, "#bf{1.5 <   #it{p}^{h}_{T,assoc} < 2.5 GeV/#it{c}}")
    elif PT_MODE == 2:
    ...
    hh_central_dphi_50_80_just_syst.GetYaxis().SetRangeUser(0, MAX_Y_RANGE)
    ...
    marker_legend.AddEntry(legend_marker, " h#minush data", "lep")
    marker_legend.AddEntry(legend_line, " UE fit", "l")
