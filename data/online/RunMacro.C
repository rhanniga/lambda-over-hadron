...
void RunMacro(bool local=true, bool full=true, bool gridMerge=true){
  ...
  gInterpreter->LoadMacro("AliAnalysisTaskStrangeCor.cxx++g");
  AliAnalysisTaskStrangeCor *task = reinterpret_cast<AliAnalysisTaskStrangeCor*>(gInterpreter->ExecuteMacro("AddStrangeCorTask.C"));
  ...
  if(local) {
    ...
    chain->Add("/home/alidock/data/AliAOD_69.root");
    chain->Add("/home/alidock/data/AliAOD_1.root");
    chain->Add("/home/alidock/data/AliAOD_420.root");
    ...
    alienHandler->SetAdditionalLibs("AliAnalysisTaskStrangeCor.cxx AliAnalysisTaskStrangeCor.h");
    alienHandler->SetAnalysisSource("AliAnalysisTaskStrangeCor.cxx");
    ...
    // addding runs
    int runArray[] = {265525, 265521, 265501, 265500, 265499, 265435, 265427, 265426, 265425, 265424, 265422, 265421, 265420, 265419, 265388, 265387, 265385, 265384, 265383, 265381, 265378, 265377, 265344, 265343, 265342, 265339, 265338, 265336, 265334, 265332, 265309};
    ...
    alienHandler->SetExecutable("StrangeCor.sh");
    alienHandler->SetJDLName("StrangeCor.jdl");
    ...
    alienHandler->SetGridWorkingDir("StrangeCor");
    alienHandler->SetGridOutputDir("06-14-2019_0_20");
