void NSigmaElectron_merge(const char *dir, Int_t stage=0)
{
...
// Analysis source to be compiled at runtime (if any)
   gROOT->ProcessLine(".L AliAnalysisTaskNSigmaElectron.cxx+g");
...
// Set temporary compilation directory to current one
   ...
   TString outputFile;
   Bool_t merged = kTRUE;
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("NSigmaElectron.root");
   if (!mgr) {
